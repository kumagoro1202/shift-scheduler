...
_TIME_SLOT_DEFINITIONS = [
    # Monday
    ("mon_reha_am", 0, "morning", "08:45", "13:00", 1, 2, "リハ室", "リハ室（月曜午前）", 1.0, None),
    ...
    # Tuesday
    ("tue_reha_am", 1, "morning", "08:45", "13:00", 1, 2, "リハ室", "リハ室（火曜午前）", 1.0, None),
    ...
    # Wednesday
    ("wed_reha_am", 2, "morning", "08:45", "13:00", 1, 2, "リハ室", "リハ室（水曜午前）", 1.0, None),
