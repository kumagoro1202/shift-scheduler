...
def _select_employment_pattern(employee, date, time_slot, daily_assignments):
    ...
    if weekday in [0, 1, 4]:  # 月火金
        candidates = ['full_time_mon_tue_fri_A', 'full_time_mon_tue_fri_B', 'full_time_mon_tue_fri_C']
    elif weekday == 2:  # 水曜
        candidates = ['full_time_wed_early', 'full_time_wed_normal', 'full_time_wed_late']
    elif weekday in [3, 5]:  # 木土
        candidates = ['full_time_thu_sat_1', 'full_time_thu_sat_2', 'full_time_thu_sat_3']
    else:
        return None  # 日曜日は休診
