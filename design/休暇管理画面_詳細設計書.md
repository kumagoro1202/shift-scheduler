...
- **21日から翌月20日の期間対応**: 月次期間は当月21日〜翌月20日で表示
...
21日から翌月20日までの期間を`get_month_range(year, month)`で計算:
- **開始日**: 当月21日
- **終了日**: 翌月20日
...
| 21日〜翌月20日期間 | 2025年12月選択 | 12/21〜1/20表示 |
