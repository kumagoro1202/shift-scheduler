...
SAMPLE_EMPLOYEES = [
    ...
    },
    {
        ...
        "employment_pattern_id": "full_mid",
        "skill_reha": 86,
        "skill_reception_am": 82,
        "skill_reception_pm": 84,
        "skill_general": 88,
    },
    {
        "name": "森田美穂",
...
SAMPLE_ABSENCES = [
    # 2025年12月
    {"employee_index": 0, "date": date(2025, 12, 9), "absence_type": "morning", "reason": "通院"},
    ...
    {"employee_index": 9, "date": date(2025, 12, 26), "absence_type": "afternoon", "reason": "研修"},
    # 2026年1月
    {"employee_index": 0, "date": date(2026, 1, 8), "absence_type": "morning", "reason": "通院"},
    {"employee_index": 2, "date": date(2026, 1, 14), "absence_type": "full_day", "reason": "有給休暇"},
    {"employee_index": 3, "date": date(2026, 1, 20), "absence_type": "afternoon", "reason": "研修"},
    {"employee_index": 6, "date": date(2026, 1, 22), "absence_type": "morning", "reason": "通院"},
    {"employee_index": 11, "date": date(2026, 1, 27), "absence_type": "morning", "reason": "健康診断"},
    # 2026年2月
    {"employee_index": 1, "date": date(2026, 2, 5), "absence_type": "afternoon", "reason": "家族行事"},
    {"employee_index": 4, "date": date(2026, 2, 10), "absence_type": "full_day", "reason": "有給休暇"},
    {"employee_index": 7, "date": date(2026, 2, 17), "absence_type": "morning", "reason": "通院"},
    {"employee_index": 8, "date": date(2026, 2, 19), "absence_type": "afternoon", "reason": "研修"},
    {"employee_index": 10, "date": date(2026, 2, 24), "absence_type": "morning", "reason": "通院"},
    # 2026年3月
    {"employee_index": 0, "date": date(2026, 3, 5), "absence_type": "afternoon", "reason": "研修"},
    {"employee_index": 3, "date": date(2026, 3, 11), "absence_type": "morning", "reason": "通院"},
    {"employee_index": 6, "date": date(2026, 3, 18), "absence_type": "full_day", "reason": "有給休暇"},
    {"employee_index": 9, "date": date(2026, 3, 24), "absence_type": "morning", "reason": "健康診断"},
    {"employee_index": 12, "date": date(2026, 3, 27), "absence_type": "afternoon", "reason": "家族行事"},
    # 2026年4月
    {"employee_index": 1, "date": date(2026, 4, 3), "absence_type": "morning", "reason": "通院"},
    {"employee_index": 2, "date": date(2026, 4, 9), "absence_type": "afternoon", "reason": "研修"},
    {"employee_index": 5, "date": date(2026, 4, 15), "absence_type": "full_day", "reason": "有給休暇"},
    {"employee_index": 8, "date": date(2026, 4, 21), "absence_type": "morning", "reason": "通院"},
    {"employee_index": 11, "date": date(2026, 4, 28), "absence_type": "afternoon", "reason": "家族行事"},
]
